 ...
 */
extern NSString *const SCTKGrantTypeAuthorizationCode;

/*! @brief For refreshing an access token with a refresh token.
    @see https://tools.ietf.org/html/rfc6749#section-6
 */
extern NSString *const SCTKGrantTypeRefreshToken;

/*! @brief For obtaining an access token with a username and password.
    @see https://tools.ietf.org/html/rfc6749#section-4.3.2
 */
extern NSString *const SCTKGrantTypePassword;
 ...
 */
extern NSString *const SCTKGrantTypeClientCredentials;
