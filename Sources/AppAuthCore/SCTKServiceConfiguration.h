...
/*! @brief Represents the information needed to construct a @c SCTKAuthorizationService.
 */
@interface SCTKServiceConfiguration : NSObject <NSCopying, NSSecureCoding>
 ...
 */
@property(nonatomic, readonly, nullable) SCTKServiceDiscovery *discoveryDocument;
