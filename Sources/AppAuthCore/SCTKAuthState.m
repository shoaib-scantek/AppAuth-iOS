...
/*! @brief Object to hold SCTKAuthState pending actions.
 */
...
/*! @brief The access token generated by the authorization server.
    @discussion Rather than using this property directly, you should call
        @c SCTKAuthState.withFreshTokenPerformAction:.
 */
...
/*! @brief ID Token value associated with the authenticated session.
    @discussion Rather than using this property directly, you should call
        SCTKAuthState.withFreshTokenPerformAction:.
 */
                         ...
                         callback:^(SCTKAuthorizationResponse *_Nullable authorizationResponse,
                           ...
                           if (authorizationResponse) {
                             if ([authorizationRequest.responseType
                                     isEqualToString:SCTKResponseTypeCode]) {
                               ...
                               SCTKAuthState *authState = [[SCTKAuthState alloc]
...
- (NSString *)description {
  return [NSString stringWithFormat:@"<%@: %p, isAuthorized: %@, refreshToken: \"%@\", "
                                    ...
                                    _scope,
                                    [SCTKTokenUtilities redact:self.accessToken],
                                    self.accessTokenExpirationDate,
                                    [SCTKTokenUtilities redact:self.idToken],
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder {
  _lastAuthorizationResponse = [aDecoder decodeObjectOfClass:[SCTKAuthorizationResponse class]
                                                      forKey:kLastAuthorizationResponseKey];
  _lastTokenResponse = [aDecoder decodeObjectOfClass:[SCTKTokenResponse class]
...
- (void)updateWithRegistrationResponse:(SCTKRegistrationResponse *)registrationResponse {
...
- (void)updateWithTokenResponse:(nullable SCTKTokenResponse *)tokenResponse
  ...
  if (_authorizationError) {
    ...
    NSLog(@"SCTKAuthState:updateWithTokenResponse should not be called in an error state [%@] call"
...
- (SCTKTokenRequest *)tokenRefreshRequest {
  return [self tokenRefreshRequestWithAdditionalParameters:nil];
}

- (SCTKTokenRequest *)tokenRefreshRequestWithAdditionalParameters:
    (NSDictionary<NSString *, NSString *> *)additionalParameters {

  if (!_refreshToken) {
    [SCTKErrorUtilities raiseException:kRefreshTokenRequestException];
  }
  return [[SCTKTokenRequest alloc]
      initWithConfiguration:_lastAuthorizationResponse.request.configuration
                  grantType:SCTKGrantTypeRefreshToken
...
- (SCTKTokenRequest *)tokenRefreshRequestWithAdditionalHeaders:
    (NSDictionary<NSString *, NSString *> *)additionalHeaders {
...
- (void)performActionWithFreshTokens:(SCTKAuthStateAction)action
  ...
  [SCTKAuthorizationService performTokenRequest:tokenRefreshRequest
                 originalAuthorizationResponse:_lastAuthorizationResponse
                                      callback:^(SCTKTokenResponse *_Nullable response,
                                                 NSError *_Nullable error) {
    // update SCTKAuthState based on response
    if (response) {
