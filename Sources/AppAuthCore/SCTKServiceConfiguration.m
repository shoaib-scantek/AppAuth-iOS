...
@interface SCTKServiceConfiguration ()
...
- (instancetype)initWithAuthorizationEndpoint:(NSURL *)authorizationEndpoint
                         ...
                         registrationEndpoint:(nullable NSURL *)registrationEndpoint
                           endSessionEndpoint:(nullable NSURL *)endSessionEndpoint
                            discoveryDocument:(nullable SCTKServiceDiscovery *)discoveryDocument
                            NS_DESIGNATED_INITIALIZER;

@end

@implementation SCTKServiceConfiguration
...
- (nullable instancetype)initWithCoder:(NSCoder *)aDecoder {
  ...
  NSSet<Class> *allowedClasses = [NSSet setWithArray:@[[SCTKServiceDiscovery class],
                                                       ...
                                                       [NSNumber class],
                                                       [NSNull class]]];
  SCTKServiceDiscovery *discoveryDocument = [aDecoder decodeObjectOfClasses:allowedClasses
