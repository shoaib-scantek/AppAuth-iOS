 ...
 */
@interface SCTKAuthorizationResponse : NSObject <NSCopying, NSSecureCoding>

/*! @brief The request which was serviced.
 */
@property(nonatomic, readonly) SCTKAuthorizationRequest *request;
 ...
 */
- (nullable SCTKTokenRequest *)tokenExchangeRequest;
...
/*! @brief Creates a token request suitable for exchanging an authorization code for an access
    ...
    @see https://tools.ietf.org/html/rfc6749#section-4.1.3
 */
- (nullable SCTKTokenRequest *)tokenExchangeRequestWithAdditionalParameters:
