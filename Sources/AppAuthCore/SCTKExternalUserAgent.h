...
@protocol SCTKExternalUserAgentRequest;
 ...
 */
@protocol SCTKExternalUserAgent<NSObject>
...
/*! @brief Presents the request in the external user-agent.
    ...
    @param session The @c SCTKExternalUserAgentSession instance that initiates presenting the UI.
        Concrete implementations of a @c SCTKExternalUserAgent may call
