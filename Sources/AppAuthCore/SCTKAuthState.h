 ...
 */
typedef void (^SCTKAuthStateAction)(NSString *_Nullable accessToken,
 ...
 */
@property(nonatomic, readonly) SCTKAuthorizationResponse *lastAuthorizationResponse;

/*! @brief The most recent token response used to update this authorization state. This will
        contain the latest access token.
 */
@property(nonatomic, readonly, nullable) SCTKTokenResponse *lastTokenResponse;
...
/*! @brief The @c SCTKAuthStateChangeDelegate delegate.
    @discussion Use the delegate to observe state changes (and update storage) as well as error
        states.
 */
@property(nonatomic, weak, nullable) id<SCTKAuthStateChangeDelegate> stateChangeDelegate;

/*! @brief The @c SCTKAuthStateErrorDelegate delegate.
    @discussion Use the delegate to observe state changes (and update storage) as well as error
        states.
 */
 ...
 */
- (instancetype)initWithAuthorizationResponse:(SCTKAuthorizationResponse *)authorizationResponse;
 ...
 */
- (instancetype)initWithAuthorizationResponse:(SCTKAuthorizationResponse *)authorizationResponse
                                tokenResponse:(nullable SCTKTokenResponse *)tokenResponse;

/*! @brief Creates an auth state from an registration response.
    @param registrationResponse The registration response.
 */
- (instancetype)initWithRegistrationResponse:(SCTKRegistrationResponse *)registrationResponse;
...
- (instancetype)initWithAuthorizationResponse:
    (nullable SCTKAuthorizationResponse *)authorizationResponse
           tokenResponse:(nullable SCTKTokenResponse *)tokenResponse
    registrationResponse:(nullable SCTKRegistrationResponse *)registrationResponse
...
/*! @brief Updates the authorization state based on a new token response.
    ...
    @discussion Typically called with the response from an authorization code exchange, or a token
        refresh.
 */
- (void)updateWithTokenResponse:(nullable SCTKTokenResponse *)tokenResponse
                          error:(nullable NSError *)error;
 ...
 */
- (void)updateWithRegistrationResponse:(nullable SCTKRegistrationResponse *)registrationResponse;
...
/*! @brief Calls the block with a valid access token (refreshing it first, if needed), or if a
    ...
    @param action The block to execute with a fresh token. This block will be executed on the main
        thread.
 */
- (void)performActionWithFreshTokens:(SCTKAuthStateAction)action;
