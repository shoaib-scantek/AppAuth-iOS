/*! @file SCTKExternalUserAgentCatalyst.m
...
@interface SCTKExternalUserAgentCatalyst ()<ASWebAuthenticationPresentationContextProviding>
@end

@implementation SCTKExternalUserAgentCatalyst {
...
- (BOOL)presentExternalUserAgentRequest:(id<SCTKExternalUserAgentRequest>)request
  ...
  __weak SCTKExternalUserAgentCatalyst *weakSelf = self;
  ...
  ASWebAuthenticationSession *authenticationVC =
    ...
    __strong SCTKExternalUserAgentCatalyst *strongSelf = weakSelf;
    if (!strongSelf) {
        return;
    }
