/*! @file SCTKExternalUserAgentIOSCustomBrowser.h
 ...
 */
typedef NSURL *_Nullable (^SCTKCustomBrowserURLTransformation)(NSURL *_Nullable requestURL);

/*! @brief An implementation of the SCTKExternalUserAgent protocol for iOS that uses
...
@interface SCTKExternalUserAgentIOSCustomBrowser : NSObject<SCTKExternalUserAgent>

/*! @brief URL transformation block for the browser.
 */
@property(nonatomic, readonly) SCTKCustomBrowserURLTransformation URLTransformation;
...
/*! @brief An instance of @c SCTKExternalUserAgentIOSCustomBrowser for Chrome.
 */
+ (instancetype)CustomBrowserChrome;

/*! @brief An instance of @c SCTKExternalUserAgentIOSCustomBrowser for Firefox.
 */
+ (instancetype)CustomBrowserFirefox;

/*! @brief An instance of @c SCTKExternalUserAgentIOSCustomBrowser for Opera.
 */
+ (instancetype)CustomBrowserOpera;

/*! @brief An instance of @c SCTKExternalUserAgentIOSCustomBrowser for Safari.
 */
...
/*! @brief SCTKExternalUserAgent for a custom browser. @c presentExternalUserAgentRequest:session method
        will return NO if the browser isn't installed.
 */
- (nullable instancetype)initWithURLTransformation:(SCTKCustomBrowserURLTransformation)URLTransformation;
