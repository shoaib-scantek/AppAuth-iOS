/*! @file SCTKExternalUserAgentIOS.m
...
@interface SCTKExternalUserAgentIOS ()<SFSafariViewControllerDelegate, ASWebAuthenticationPresentationContextProviding>
@end
#else
@interface SCTKExternalUserAgentIOS ()<SFSafariViewControllerDelegate>
@end
#endif

@implementation SCTKExternalUserAgentIOS {
...
- (BOOL)presentExternalUserAgentRequest:(id<SCTKExternalUserAgentRequest>)request
  ...
  if (@available(iOS 12.0, *)) {
    ...
    if (!UIAccessibilityIsGuidedAccessEnabled()) {
      __weak SCTKExternalUserAgentIOS *weakSelf = self;
      ...
      ASWebAuthenticationSession *authenticationVC =
        ...
        __strong SCTKExternalUserAgentIOS *strongSelf = weakSelf;
        if (!strongSelf) {
            return;
        }
